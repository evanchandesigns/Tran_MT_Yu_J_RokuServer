...
--
-- Host: localhost    Database: roku_streaming
-- ------------------------------------------------------
...
CREATE TABLE `tbl_arating` (
  `arating_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_cast` (
  `cast_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_mov_cast` (
  `mov_cast_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
  `cast_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_mov_country` (
  `mov_country_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_mov_director` (
  `mov_director_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_mov_genre` (
  `mov_genre_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_mov_lang` (
  `mov_lang_id` smallint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_mov_studio` (
  `mov_studio_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint NOT NULL,
...
CREATE TABLE `tbl_movies` (
  `movies_id` mediumint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_studio` (
  `studio_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_user` VALUES (1,'trevor','user1','password','t@t.com','2019-02-01 19:07:35','::1',1,5);
...
-- Dump completed on 2021-02-09 10:16:58
